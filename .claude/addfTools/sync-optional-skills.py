...
使い方:
  python3 sync-optional-skills.py          # check モード（lint。変更しない）
  python3 sync-optional-skills.py apply    # 配置・撤去を実行する
        ...
        if not os.path.exists(dst):
            if apply_mode:
                ...
                warnings.append(
                    ...
                    f' `python3 .claude/addfTools/sync-optional-skills.py apply` で配置する')
