...
import RE2 from 're2';
import { extractMentions } from '@/misc/extract-mentions.ts';
import { extractCustomEmojisFromMfm } from '@/misc/extract-custom-emojis-from-mfm.ts';
import { extractHashtags } from '@/misc/extract-hashtags.ts';
import type { IMentionedRemoteUsers } from '@/models/Note.ts';
import { MiNote } from '@/models/Note.ts';
import type { ChannelFollowingsRepository, ChannelsRepository, FollowingsRepository, InstancesRepository, MiFollowing, MutingsRepository, NotesRepository, NoteThreadMutingsRepository, UserListMembershipsRepository, UserProfilesRepository, UsersRepository } from '@/models/_.ts';
import type { MiDriveFile } from '@/models/DriveFile.ts';
import type { MiApp } from '@/models/App.ts';
import { concat } from '@/misc/prelude/array.ts';
...
import type { MiUserProfile } from '@/models/UserProfile.ts';
...
import { AntennaService } from '@/core/AntennaService.ts';
...
import { DB_MAX_NOTE_TEXT_LENGTH } from '@/const.ts';
