...
import { NotePiningService } from '@/core/NotePiningService.ts';
import { UserBlockingService } from '@/core/UserBlockingService.ts';
import { NoteDeleteService } from '@/core/NoteDeleteService.ts';
import { NoteCreateService } from '@/core/NoteCreateService.ts';
import { concat, toArray, toSingle, unique } from '@/misc/prelude/array.ts';
...
import type { UsersRepository, NotesRepository, FollowingsRepository, AbuseUserReportsRepository, FollowRequestsRepository } from '@/models/_.ts';
import { bindThis } from '@/decorators.ts';
import type { MiRemoteUser } from '@/models/User.ts';
import { getApHrefNullable, getApId, getApIds, getApType, isAccept, isActor, isAdd, isAnnounce, isBlock, isCollection, isCollectionOrOrderedCollection, isCreate, isDelete, isFlag, isFollow, isLike, isMove, isPost, isReject, isRemove, isTombstone, isUndo, isUpdate, validActor, validPost } from './type.ts';
import { ApNoteService } from './models/ApNoteService.ts';
...
import { ApAudienceService } from './ApAudienceService.ts';
import { ApPersonService } from './models/ApPersonService.ts';
import { ApQuestionService } from './models/ApQuestionService.ts';
import type { Resolver } from './ApResolverService.ts';
import type { IAccept, IAdd, IAnnounce, IBlock, ICreate, IDelete, IFlag, IFollow, ILike, IObject, IReject, IRemove, IUndo, IUpdate, IMove } from './type.ts';
