...
import type { PollsRepository, EmojisRepository } from '@/models/_.ts';
import type { Config } from '@/config.ts';
import type { MiRemoteUser } from '@/models/User.ts';
import type { MiNote } from '@/models/Note.ts';
import { toArray, toSingle, unique } from '@/misc/prelude/array.ts';
...
import { getOneApId, getApId, getOneApHrefNullable, validPost, isEmoji, getApType } from '../type.ts';
...
import { ApMentionService } from './ApMentionService.ts';
import { ApQuestionService } from './ApQuestionService.ts';
import { ApImageService } from './ApImageService.ts';
import type { Resolver } from '../ApResolverService.ts';
import type { IObject, IPost } from '../type.ts';
