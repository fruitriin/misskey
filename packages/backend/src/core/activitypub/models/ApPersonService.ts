...
import type { FollowingsRepository, InstancesRepository, UserProfilesRepository, UserPublickeysRepository, UsersRepository } from '@/models/_.ts';
...
import type { CacheService } from '@/core/CacheService.ts';
...
import type { IdService } from '@/core/IdService.ts';
import type { MfmService } from '@/core/MfmService.ts';
import { toArray } from '@/misc/prelude/array.ts';
import type { GlobalEventService } from '@/core/GlobalEventService.ts';
import type { FederatedInstanceService } from '@/core/FederatedInstanceService.ts';
import type { FetchInstanceMetadataService } from '@/core/FetchInstanceMetadataService.ts';
import { MiUserProfile } from '@/models/UserProfile.ts';
import { MiUserPublickey } from '@/models/UserPublickey.ts';
import type UsersChart from '@/core/chart/charts/users.ts';
import type InstanceChart from '@/core/chart/charts/instance.ts';
import type { HashtagService } from '@/core/HashtagService.ts';
import { MiUserNotePining } from '@/models/UserNotePining.ts';
import { StatusError } from '@/misc/status-error.ts';
import type { UtilityService } from '@/core/UtilityService.ts';
import type { UserEntityService } from '@/core/entities/UserEntityService.ts';
...
import type { AccountMoveService } from '@/core/AccountMoveService.ts';
import { checkHttps } from '@/misc/check-https.ts';
import { getApId, getApType, getOneApHrefNullable, isActor, isCollection, isCollectionOrOrderedCollection, isPropertyValue } from '../type.ts';
import { extractApHashtags } from './tag.ts';
import type { OnModuleInit } from '@nestjs/common';
import type { ApNoteService } from './ApNoteService.ts';
import type { ApMfmService } from '../ApMfmService.ts';
import type { ApResolverService, Resolver } from '../ApResolverService.ts';
import type { ApLoggerService } from '../ApLoggerService.ts';
// eslint-disable-next-line @typescript-eslint/consistent-type-imports
import type { ApImageService } from './ApImageService.ts';
import type { IActor, IObject } from '../type.ts';
